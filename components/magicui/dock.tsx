      ...
      <motion.div
        ...
        className={cn(
          dockVariants({ className }),
          {
            ...
            "fixed bottom-4 left-1/2 transform -translate-x-1/2 z-50": fixed,
            "mx-auto mt-8": !fixed,
          }
        )}
      >
...
const DockIcon = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "flex aspect-square cursor-pointer items-center justify-center rounded-full bg-white/20 hover:bg-white/30 transition-colors",
        className,
      )}
      {...props}
    >
